...
Hello! I’m Gaurav Singh, originally from India and currently evolving my expertise in Machine Learning (ML) at Griffith University, Gold Coast, Australia. My journey combines together a [foundation in computer science](/education/bachelors-cs/) with an interest for visual arts and a commitment to creative and ethical practice. My [work](/work/) explores ML within human-computer interaction (HCI) and engineering, striving to make data analysis more accessible while considering its societal and ethical dimensions. This focus drives my projects and future ambitions for meaningful technology innovation.
