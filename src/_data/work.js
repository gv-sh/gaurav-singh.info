...
export default [
  ...
  },
  {
    ...
    years: "2015–2026",
    blurb:
      "A design lab I started in 2015 with two good friends, Prakhar and Swati. We wanted to help people build digital interfaces across disciplines, but we never quite materialised what we had in our heads, and we closed it this year. We may well try it again somewhere down the line.",
  },
  {
    org: "Stealth startup",
    role: "Software developer",
  ...
  },
  {
    ...
    years: "2016",
    blurb:
      "Research assistant on Art in Transit, a public art and design project with the Bangalore Metro, under Abhiyan Humane and Arzu Mistry. A year spent on design out in public space rather than on a screen.",
  },
  {
    org: "Independent designer",
    role: "Freelance",
    place: "Remote",
    years: "2008–2015",
    blurb:
      "Seven years working on my own, mostly through design competitions and client projects for companies around the world, among them IBM, Honeywell, Accenture and AstraZeneca. It paid for the experiments and taught me to ship.",
  },
  {
    org: "S.Labs",
    ...
    years: "2014",
    blurb:
      "A short research internship under Atul Saraf, and where my first paper, SnapTag, started taking shape.",
  },
];
