// Degree theses, newest first. Hand-maintained from the CV / education records.
export default [
  {
    year: "2025",
    title:
  ...
  },
  {
    year: "2015",
    title: "Living Energy",
    note: "Innovation & Experience Design, Srishti; supervised by Naveen Bagalkot and Abhiyan Humane",
    blurb:
      "A design thesis on harvesting electricity from piezoelectric Rochelle salt for an off-grid village. Equal parts material experiment and a question about who technology actually gets built for.",
  },
  {
    year: "2012",
