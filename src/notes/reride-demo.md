...
Over the last couple of months, we have put together a [working prototype of ReRide](/notes/reride-s-next-iteration/). The prototype reads the rider’s posture through multiple sensor points and displays ‘glanceable’ feedback in the dashboard area of the bike, and stores this information in a remote server for later access.

We are [demoing ReRide at Interact 2017 Conference](/notes/interact-2017/) in IIT Bombay from 27–29th September 2017.
...
Our Team: [Dr.Naveen Bagalkot](/notes/dr-naveen-bagalkot/), Dr.Tomas Sokoler, Riyaz Shaikh, Gaurav Singh, Anders Edelbo Lillie, Vignesh Chakravarthy, Pratiksha Dixit, Sapna Nayak, Mangesh Ashrit, Somya Saxena, Ashwin Senthil Kumar, and Aditi Rai.
