...
meta: 2017
deck: Exploration
description: The workshop aimed to introduce first-year design students to Object Oriented Design and how to apply it to develop new interactions and interfaces. Through the workshop, students learned key principles and concepts from this paradigm, which they also used to break down popular products to understand how they might have worked. They also gained experience in using Processing IDE + Processing Android to build tangible prototypes.
layout: base.njk
permalink: /teaching/digital-making
--- 
